...
var G__3304 = (root.arr[(slc - (1))]);
var G__3305 = (shift - (5));
var G__3306 = (((rngs[(31)]) - (rngs[(30)])) + (32));
root = G__3304;
shift = G__3305;
cnt = G__3306;
continue;
...
if((!(r_QMARK_))){
var rngs_3315 = clojure.core.rrb_vector.nodes.ranges.call(null,parent);
var rng0_3316 = (rngs_3315[(0)]);
var new_rngs_3317 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
var lim_3318 = (rngs_3315[(32)]);
cljs.core.array_copy.call(null,rngs_3315,(1),new_rngs_3317,(0),(lim_3318 - (1)));

var i_3319 = (0);
while(true){
if((i_3319 < lim_3318)){
(new_rngs_3317[i_3319] = ((new_rngs_3317[i_3319]) - rng0_3316));
...
(new_rngs_3317[(32)] = ((rngs_3315[(32)]) - (1)));

(new_rngs_3317[((rngs_3315[(32)]) - (1))] = (0));

(new_arr[(32)] = new_rngs_3317);
} else {
}
...
while(true){
if((i_3321 <= li)){
(new_rngs[i_3321] = ((new_rngs[(i_3321 - (1))]) + step));
...
var G__3327 = (j_3325 + (1));
var G__3328 = (r_3326 + step);
j_3325 = G__3327;
r_3326 = G__3328;
continue;
} else {
...
var rngs = (((!(reg_QMARK_)))?(function (){var G__3329 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
(G__3329[(0)] = node.arr.length);
...
var arr_3330__$1 = arr;
var shift_3331__$1 = shift;
while(true){
if((shift_3331__$1 === (5))){
if((!(reg_QMARK_))){
(arr_3330__$1[(32)] = rngs);
} else {
}

(arr_3330__$1[(0)] = node);
} else {
var a_3332 = (new Array(len));
var e_3333 = cljs.core.__GT_VectorNode.call(null,null,a_3332);
(arr_3330__$1[(0)] = e_3333);
...
var G__3334 = a_3332;
var G__3335 = (shift_3331__$1 - (5));
arr_3330__$1 = G__3334;
shift_3331__$1 = G__3335;
continue;
}
break;
}
