...
fipp.edn.pretty_coll = (function fipp$edn$pretty_coll(p__3748,open,xs,sep,close,f){
var map__3749 = p__3748;
var map__3749__$1 = (((((!((map__3749 == null))))?(((((map__3749.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3749.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__3749):map__3749);
var printer = map__3749__$1;
var print_level = cljs.core.get.call(null,map__3749__$1,new cljs.core.Keyword(null,"print-level","print-level",-1825423733));
var print_length = cljs.core.get.call(null,map__3749__$1,new cljs.core.Keyword(null,"print-length","print-length",1931866356));
var printer__$1 = (function (){var G__3751 = printer;
if(cljs.core.truth_(print_level)){
return cljs.core.update.call(null,G__3751,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),cljs.core.dec);
} else {
return G__3751;
}
})();
var xform = cljs.core.comp.call(null,(cljs.core.truth_(print_length)?cljs.core.take.call(null,print_length):cljs.core.identity),cljs.core.map.call(null,(function (p1__3747_SHARP_){
return f.call(null,printer__$1,p1__3747_SHARP_);
...
(fipp.edn.EdnPrinter.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4382__auto__,k3753,else__4383__auto__){
var self__ = this;
var this__4382__auto____$1 = this;
var G__3757 = k3753;
var G__3757__$1 = (((G__3757 instanceof cljs.core.Keyword))?G__3757.fqn:null);
switch (G__3757__$1) {
case "symbols":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k3753,else__4383__auto__);
...
return cljs.core.reduce.call(null,(function (ret__4402__auto__,p__3758){
var vec__3759 = p__3758;
var k__4403__auto__ = cljs.core.nth.call(null,vec__3759,(0),null);
var v__4404__auto__ = cljs.core.nth.call(null,vec__3759,(1),null);
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__3752){
var self__ = this;
var G__3752__$1 = this;
return (new cljs.core.RecordIter((0),G__3752__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"symbols","symbols",1211743),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
}));
...
(fipp.edn.EdnPrinter.prototype.fipp$visit$IVisitor$visit_tagged$arity$2 = (function (this$,p__3762){
var self__ = this;
...
var tag = cljs.core.get.call(null,map__3763__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var form = cljs.core.get.call(null,map__3763__$1,new cljs.core.Keyword(null,"form","form",-1624062471));
var this$__$1 = this;
...
var self__ = this;
var this$__$1 = this;
return fipp.edn.pretty_coll.call(null,this$__$1,"{",x,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),",",new cljs.core.Keyword(null,"line","line",212345235)], null),"}",(function (printer,p__3765){
var vec__3766 = p__3765;
var k = cljs.core.nth.call(null,vec__3766,(0),null);
var v = cljs.core.nth.call(null,vec__3766,(1),null);
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this3754,other3755){
var self__ = this;
var this3754__$1 = this;
return (((!((other3755 == null)))) && ((this3754__$1.constructor === other3755.constructor)) && (cljs.core._EQ_.call(null,this3754__$1.symbols,other3755.symbols)) && (cljs.core._EQ_.call(null,this3754__$1.print_meta,other3755.print_meta)) && (cljs.core._EQ_.call(null,this3754__$1.print_length,other3755.print_length)) && (cljs.core._EQ_.call(null,this3754__$1.print_level,other3755.print_level)) && (cljs.core._EQ_.call(null,this3754__$1.__extmap,other3755.__extmap)));
}));
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4387__auto__,k__4388__auto__,G__3752){
var self__ = this;
var this__4387__auto____$1 = this;
var pred__3769 = cljs.core.keyword_identical_QMARK_;
var expr__3770 = k__4388__auto__;
if(cljs.core.truth_(pred__3769.call(null,new cljs.core.Keyword(null,"symbols","symbols",1211743),expr__3770))){
return (new fipp.edn.EdnPrinter(G__3752,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__3769.call(null,new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),expr__3770))){
return (new fipp.edn.EdnPrinter(self__.symbols,G__3752,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__3769.call(null,new cljs.core.Keyword(null,"print-length","print-length",1931866356),expr__3770))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,G__3752,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__3769.call(null,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),expr__3770))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,G__3752,self__.__meta,self__.__extmap,null));
} else {
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4388__auto__,G__3752),null));
}
}
}
}
...
(fipp.edn.EdnPrinter.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4379__auto__,G__3752){
var self__ = this;
var this__4379__auto____$1 = this;
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,G__3752,self__.__extmap,self__.__hash));
}));
 ...
 */
fipp.edn.map__GT_EdnPrinter = (function fipp$edn$map__GT_EdnPrinter(G__3756){
var extmap__4419__auto__ = (function (){var G__3772 = cljs.core.dissoc.call(null,G__3756,new cljs.core.Keyword(null,"symbols","symbols",1211743),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733));
if(cljs.core.record_QMARK_.call(null,G__3756)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__3772);
} else {
return G__3772;
}
})();
return (new fipp.edn.EdnPrinter(new cljs.core.Keyword(null,"symbols","symbols",1211743).cljs$core$IFn$_invoke$arity$1(G__3756),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598).cljs$core$IFn$_invoke$arity$1(G__3756),new cljs.core.Keyword(null,"print-length","print-length",1931866356).cljs$core$IFn$_invoke$arity$1(G__3756),new cljs.core.Keyword(null,"print-level","print-level",-1825423733).cljs$core$IFn$_invoke$arity$1(G__3756),null,cljs.core.not_empty.call(null,extmap__4419__auto__),null));
});
...
var _STAR_print_meta_STAR__orig_val__3776 = cljs.core._STAR_print_meta_STAR_;
var _STAR_print_meta_STAR__temp_val__3777 = false;
(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__temp_val__3777);

try{return fipp.engine.pprint_document.call(null,fipp.visit.visit.call(null,printer,x),options);
}finally {(cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__orig_val__3776);
}}));
