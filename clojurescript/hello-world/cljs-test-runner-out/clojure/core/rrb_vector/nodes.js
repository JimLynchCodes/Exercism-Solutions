...
var G__3309 = (root.arr[(slc - (1))]);
var G__3310 = (shift - (5));
var G__3311 = (((rngs[(31)]) - (rngs[(30)])) + (32));
root = G__3309;
shift = G__3310;
cnt = G__3311;
continue;
...
if((!(r_QMARK_))){
var rngs_3320 = clojure.core.rrb_vector.nodes.ranges.call(null,parent);
var rng0_3321 = (rngs_3320[(0)]);
var new_rngs_3322 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
var lim_3323 = (rngs_3320[(32)]);
cljs.core.array_copy.call(null,rngs_3320,(1),new_rngs_3322,(0),(lim_3323 - (1)));

var i_3324 = (0);
while(true){
if((i_3324 < lim_3323)){
(new_rngs_3322[i_3324] = ((new_rngs_3322[i_3324]) - rng0_3321));
...
(new_rngs_3322[(32)] = ((rngs_3320[(32)]) - (1)));

(new_rngs_3322[((rngs_3320[(32)]) - (1))] = (0));

(new_arr[(32)] = new_rngs_3322);
} else {
}
...
while(true){
if((i_3326 <= li)){
(new_rngs[i_3326] = ((new_rngs[(i_3326 - (1))]) + step));
...
var G__3332 = (j_3330 + (1));
var G__3333 = (r_3331 + step);
j_3330 = G__3332;
r_3331 = G__3333;
continue;
} else {
...
var rngs = (((!(reg_QMARK_)))?(function (){var G__3334 = [null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null];
(G__3334[(0)] = node.arr.length);
...
var arr_3335__$1 = arr;
var shift_3336__$1 = shift;
while(true){
if((shift_3336__$1 === (5))){
if((!(reg_QMARK_))){
(arr_3335__$1[(32)] = rngs);
} else {
}

(arr_3335__$1[(0)] = node);
} else {
var a_3337 = (new Array(len));
var e_3338 = cljs.core.__GT_VectorNode.call(null,null,a_3337);
(arr_3335__$1[(0)] = e_3338);
...
var G__3339 = a_3337;
var G__3340 = (shift_3336__$1 - (5));
arr_3335__$1 = G__3339;
shift_3336__$1 = G__3340;
continue;
}
break;
}
