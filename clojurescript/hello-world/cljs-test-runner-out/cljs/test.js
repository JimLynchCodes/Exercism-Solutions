...
return cljs.core.assoc.call(null,G__3234,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__3234;
}
}));
...
var len__4736__auto___3239 = arguments.length;
var i__4737__auto___3240 = (0);
while(true){
if((i__4737__auto___3240 < len__4736__auto___3239)){
args__4742__auto__.push((arguments[i__4737__auto___3240]));

var G__3241 = (i__4737__auto___3240 + (1));
i__4737__auto___3240 = G__3241;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq3236){
var G__3237 = cljs.core.first.call(null,seq3236);
var seq3236__$1 = cljs.core.next.call(null,seq3236);
var G__3238 = cljs.core.first.call(null,seq3236__$1);
var seq3236__$2 = cljs.core.next.call(null,seq3236__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__3237,G__3238,seq3236__$2);
}));
...
var map__3243 = m;
var map__3243__$1 = (((((!((map__3243 == null))))?(((((map__3243.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3243.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__3243):map__3243);
var file = cljs.core.get.call(null,map__3243__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__3243__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__3243__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,(function (p1__3242_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__3242_SHARP_));
...
var temp__5735__auto___3245 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5735__auto___3245)){
var message_3246 = temp__5735__auto___3245;
cljs.core.println.call(null,message_3246);
} else {
}
...
var output_dir__$1 = (function (){var G__3249 = output_dir;
...
var temp__5733__auto__ = ((typeof exception.stack === 'string')?(function (){var G__3251 = exception.stack;
var G__3251__$1 = (((G__3251 == null))?null:clojure.string.split_lines.call(null,G__3251));
var G__3251__$2 = (((G__3251__$1 == null))?null:cljs.core.get.call(null,G__3251__$1,depth));
if((G__3251__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__3251__$2);
}
})():false);
if(cljs.core.truth_(temp__5733__auto__)){
var stack_element = temp__5733__auto__;
var fname = cljs.test.js_filename.call(null,stack_element);
var vec__3252 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__3252,(0),null);
var column = cljs.core.nth.call(null,vec__3252,(1),null);
var vec__3255 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__3255,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__3255,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__3255,(2),null);
...
var m__$1 = (function (){var G__3258 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__3262 = (function (){var G__3261 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__3261);
} else {
return G__3261;
}
})();
...
return cljs.core.vary_meta.call(null,G__3263,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e3264){var e = e3264;
var G__3265 = e;
var G__3265__$1 = (((G__3265 instanceof cljs.core.Keyword))?G__3265.fqn:null);
switch (G__3265__$1) {
...
var vec__3267 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__3267,(0),null);
var types = vec__3267;
...
return cljs.core.map.call(null,(function (p__3270){
var vec__3271 = p__3270;
var ns = cljs.core.nth.call(null,vec__3271,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__3271,(1),null);
return (function (){
...
var G__3274 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
var seq__3275 = cljs.core.seq.call(null,vars__$1);
var chunk__3276 = null;
var count__3277 = (0);
var i__3278 = (0);
while(true){
if((i__3278 < count__3277)){
var v = cljs.core._nth.call(null,chunk__3276,i__3278);
var temp__5735__auto___3280 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___3280)){
var t_3281 = temp__5735__auto___3280;
each_fixture_fn.call(null,((function (seq__3275,chunk__3276,count__3277,i__3278,t_3281,temp__5735__auto___3280,v,each_fixture_fn,G__3274,G__3274__$1,env,once_fixtures,each_fixtures,vec__3271,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_3281)));
});})(seq__3275,chunk__3276,count__3277,i__3278,t_3281,temp__5735__auto___3280,v,each_fixture_fn,G__3274,G__3274__$1,env,once_fixtures,each_fixtures,vec__3271,ns,vars__$1))
);
} else {
}


var G__3282 = seq__3275;
var G__3283 = chunk__3276;
var G__3284 = count__3277;
var G__3285 = (i__3278 + (1));
seq__3275 = G__3282;
chunk__3276 = G__3283;
count__3277 = G__3284;
i__3278 = G__3285;
...
var temp__5735__auto__ = cljs.core.seq.call(null,seq__3275);
if(temp__5735__auto__){
var seq__3275__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__3275__$1)){
var c__4556__auto__ = cljs.core.chunk_first.call(null,seq__3275__$1);
var G__3286 = cljs.core.chunk_rest.call(null,seq__3275__$1);
var G__3287 = c__4556__auto__;
var G__3288 = cljs.core.count.call(null,c__4556__auto__);
var G__3289 = (0);
seq__3275 = G__3286;
chunk__3276 = G__3287;
count__3277 = G__3288;
...
var v = cljs.core.first.call(null,seq__3275__$1);
var temp__5735__auto___3290__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5735__auto___3290__$1)){
var t_3291 = temp__5735__auto___3290__$1;
each_fixture_fn.call(null,((function (seq__3275,chunk__3276,count__3277,i__3278,t_3291,temp__5735__auto___3290__$1,v,seq__3275__$1,temp__5735__auto__,each_fixture_fn,G__3274,G__3274__$1,env,once_fixtures,each_fixtures,vec__3271,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_3291)));
});})(seq__3275,chunk__3276,count__3277,i__3278,t_3291,temp__5735__auto___3290__$1,v,seq__3275__$1,temp__5735__auto__,each_fixture_fn,G__3274,G__3274__$1,env,once_fixtures,each_fixtures,vec__3271,ns,vars__$1))
);
} else {
}


var G__3292 = cljs.core.next.call(null,seq__3275__$1);
var G__3293 = null;
var G__3294 = (0);
var G__3295 = (0);
seq__3275 = G__3292;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__3274__$1)].join('')));
